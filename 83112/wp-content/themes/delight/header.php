...
if((is_single()||is_page()) && $meta_seo &&  array_key_exists('title',$meta_seo)){
	...
	echo get_pix_option('pix_array_term_seotitle_'. $the_term);
} elseif(is_category() && get_pix_option('pix_array_term_seotitle_'. $the_category)!='') {
	echo get_pix_option('pix_array_term_seotitle_'. $the_category);
} else {
		wp_title( '|', true, 'right' );
...
<?php if((is_single()||is_page()) && $meta_seo && array_key_exists('description',$meta_seo)){ ?>
	...
	<?php } elseif(is_tax() && get_pix_option('pix_array_term_seodescription_'. $the_term)!='') {
			echo '<meta name="description" content="'.get_pix_option('pix_array_term_seodescription_'. $the_term).'">';
		} elseif(is_category() && get_pix_option('pix_array_term_seodescription_'. $the_category)!='') {
			echo '<meta name="description" content="'.get_pix_option('pix_array_term_seodescription_'. $the_category).'">';
		}
...
<?php } elseif(is_tax() && get_pix_option('pix_array_term_seokeywords_'. $the_term)!='') {
			echo '<meta name="keywords" content="'.get_pix_option('pix_array_term_seokeywords_'. $the_term).'">';
		} elseif(is_category() && get_pix_option('pix_array_term_seokeywords_'. $the_category)!='') {
			echo '<meta name="keywords" content="'.get_pix_option('pix_array_term_seokeywords_'. $the_category).'">';
		} ?>
...
<?php } else {
	...
	<header <?php if(get_pix_option('pix_header_position')!='scrollable') { ?>data-position="fixed" data-top="0" data-bottom="not"<?php } ?>>
    	<div id="logo">
		<img src="http://jeninaandmike.com/83113/images/logo.png" />
