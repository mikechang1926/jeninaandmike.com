...
smarty_core_load_plugins(array('plugins' => array(array('function', 'combine_script', 'admin.tpl', 1, false),array('block', 'footer_script', 'admin.tpl', 2, false),array('modifier', 'translate', 'admin.tpl', 34, false),)), $this); ?>
...
<?php echo $this->_plugins['function']['combine_script'][0][0]->func_combine_script(array('id' => 'raphael','load' => 'footer','path' => 'themes/default/js/raphael.js'), $this);?>

<?php $this->_tag_stack[] = array('footer_script', array('require' => 'raphael')); $_block_repeat=true;$this->_plugins['block']['footer_script'][0][0]->block_footer_script($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?><?php echo '
jQuery(document).ready(function(){
