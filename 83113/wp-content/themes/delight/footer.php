...
<?php if(get_pix_option('pix_footer_show')=='show'){ ?>
    ...
    <?php 
		...
		||
		((is_single() || is_page()) && $meta_image['background']=='slideshow')
		||
		((is_single() || is_page()) && ($meta_image['background']=='default' || $meta_image['background']=='') && get_pix_option('pix_general_background')=='slideshow')
		||
		...
		(is_404() && get_pix_option('pix_404_slide')=='default' && get_pix_option('pix_general_background')=='slideshow')	
            ...
            <?php if(get_pix_option('pix_photocredits_show')=='show' || get_pix_option('pix_photocommands_show')=='show' || get_pix_option('pix_footerthumbnail_show')=='show'){ ?><div id="pix_controls">
                ...
                <div id="hide_credits_pictures"><div id="pix_credits_pictures">Credits</div></div>
    ...
    <?php } else if ((is_home()) && get_pix_option('pix_home_background') == 'video'
		...
		||
		(is_single() || is_page()) && $meta_image['background']=='video'
		||
		(is_single() || is_page()) && $meta_image['background']=='default' && get_pix_option('pix_general_background')=='video'
		||
...
<link rel="stylesheet" type="text/css" href="http://jeninaandmike.com/countdown/countdown_files/css/style.css">
<!--[if IE 6]><link rel="stylesheet" type="text/css" href="http://jeninaandmike.com/countdown/countdown_files/css/IE_6.css" /><![endif]-->
<!--[if IE 7]><link rel="stylesheet" type="text/css" href="http://jeninaandmike.com/countdown/countdown_files/css/IE_7.css" /><![endif]-->
</body>
