...
class pixThumbGallery extends WP_Widget
{
	...
	?>
		...
		?>
            	<img src="<?php echo get_template_directory_uri(); ?>/scripts/timthumb<?php echo $timthumb_cache; ?>.php?src=<?php echo pix_image_path($thumb_src[0]); ?>&amp;h=64&amp;w=64" alt="<?php echo $image['title']; ?>">
...
<?php $i++; }  ?>
	...
	?>
		...
		?>
            	<img src="<?php echo get_template_directory_uri(); ?>/scripts/timthumb<?php echo $timthumb_cache; ?>.php?src=<?php echo pix_image_path($thumb_src[0]); ?>&amp;h=64&amp;w=64" alt="<?php echo get_post_meta($image_id, '_wp_attachment_image_alt', true); ?>">
            <div class="linkIcon" style="width:64px; height:64px;">
                <a href="<?php if($click == 'colorbox') { echo $image_url; } else { the_permalink(); } ?>" class="<?php if($click == 'colorbox') { echo 'enlarge-icon'; } else { echo 'goto-icon'; } ?>" data-rel="thumbgallery"></a>
            </div>
       </div><!-- .imgHentry -->
