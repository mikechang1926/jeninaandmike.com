...
$playlist_url =  urlencode( WP_PLUGIN_URL . "/tierra-audio-with-autoresume/playlist.php?media_id=$media_id&id=$playlist_id");
$embedcode = '[ti_audio ';
if ($media_id > 0)	{
...
echo<<<__END_OF_PREVIEW___
	...
	<script language="javascript">
		...
		AC_FL_RunContent(
			...
			'flashvars', 'autoplay=1&autoresume=1&repeat=0&playlist_url=$playlist_url',
			'movie', 'swf/xspf_player',
			'salign', ''
		); //end AC code
		
		
		function updateSnippet()	{
			jQuery(".embedCode").html("$embedcode" + autoplayStatus + autoresumeStatus +  repeatStatus + randomStatus + volume + "]");
		...
		jQuery(function() {
			...
			jQuery("input#chk_resume").change(function()	{
				 if(jQuery(this).attr('checked'))	{
					autoresumeStatus = ' autoresume="1"';
				 } else	{
					autoresumeStatus = '';
				 }
	...
	<noscript>
		<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,0,0" width="400" height="170" id="xspf_player" align="middle">
		<param name="allowScriptAccess" value="sameDomain" />
		<param name="allowFullScreen" value="false" />
		<param name="movie" value="swf/xspf_player.swf?autoplay=1&autoresume=1&playlist_url=$playlist_url" /><param name="quality" value="high" /><param name="bgcolor" value="#ffffff" />
		<embed src="swf/xspf_player.swf?autoplay=1&autoresume=1&playlist_url=$playlist_url" quality="high" bgcolor="#ffffff" width="400" height="170" name="xspf_player" align="middle" allowScriptAccess="sameDomain" allowFullScreen="false" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />
		</object>
	</noscript>
	</div>
	<hr>
	...
	<form id="option_form"  class="centerLine">
		...
		<br/>Resume playing on page changes: <input class="floatRight" id="chk_resume" type="checkbox" value="on"/>
