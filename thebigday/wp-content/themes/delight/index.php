        ...
        $the_title = get_the_title();
            ...
            <div id="post-<?php the_ID(); ?>" <?php post_class('hentry'); ?>>
                ...
                <?php if(has_post_thumbnail() && get_pix_option('pix_frontpage_featured_image') != 'true') {
                    ...
                    ?><div class="imgHentry"><img src="<?php echo get_template_directory_uri(); ?>/scripts/timthumb<?php echo $timthumb_cache; ?>.php?src=<?php echo pix_image_path($imgdata[0]).$sizes; ?>" style="display:block" alt=""><div class="linkIcon"<?php echo $new_size; ?>>
